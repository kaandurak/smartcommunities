...
const gridClass = computed(() => {
  ...
  if (count === 1) return 'grid-cols-1' // 1 album: full width
  if (count === 2) return 'grid-cols-2' // 2 albums: side by side
  if (count === 3) return 'grid-cols-2' // 3 albums: custom layout
  return 'grid-cols-2' // 4 albums: 2x2 grid
})
      ...
      <div class="col-start-2 col-span-10">
        <div class="grid grid-cols-2 gap-12">
          ...
          <div class="flex flex-col h-[600px]">
            ...
            <div 
              class="grid gap-4 flex-1 overflow-y-auto"
              :class="gridClass"
            >
              <button
                ...
                class="relative rounded-2xl overflow-hidden group cursor-pointer border-4 h-full min-h-[180px]"
                :class="getAlbumSpan(index)"
